...
public class Core {
	 ...
	 * @param fromQQ
	 */
	public static void selectGroupMemberList(long selfQQ,long fromGroup){
		JSONObject json = new JSONObject();
		json.put("type", 215);
		json.put("selfQQ", selfQQ);
		json.put("fromGroup", fromGroup);
	 ...
	 * @param fromGroup
	 * @param fromQQ
	 * @param isOpen	0取消 1设置
	 */
	public static void setUpAdmin(long selfQQ,long fromGroup,long fromQQ,int isOpen){
		JSONObject json = new JSONObject();
		json.put("type", 216);
		json.put("selfQQ", selfQQ);
		json.put("fromGroup", fromGroup);
